...
(function() {
  this.ng_app = angular.module('Dantarian', ['ngMdIcons', 'ngResource', 'angular.validators', 'sessionController', 'mainController', 'booksController']).config([
    "$httpProvider", '$resourceProvider', function(provider, resource) {
      provider.defaults.headers.common['X-CSRF-Token'] = $('meta[name=csrf-token]').attr('content');
      return resource.defaults.stripTrailingSlashes = false;
    }
  ]);

  $(document).on('ready page:load', function() {
    return angular.bootstrap(document.body, ['Dantarian']);
  });
...
(function() {
  ...
  ng_app.factory("NetManager", [
    '$q', '$http', function($q, $http, $resource) {
      var net;
      net = {
        ...
        post: function(url, data_, flag) {
          ...
          deferred = $q.defer();
          base = '';
          $http.post(base + url, data_).success(function(data) {
            return deferred.resolve(data);
          }).error(function(data) {
            return alert('操作失败！');
          });
...
(function() {
  this.booksCtrl = angular.module('booksController', []);

  this.booksCtrl.controller("BooksCtrl", [
    '$scope', '$interval', '$window', 'NetManager', function($scope, $interval, $window, NetManager) {
      var scope_attrs;
      $scope.$watch('isbn', function() {
        var isbn;
        isbn = $scope.isbn;
      ...
      return angular.extend($scope, scope_attrs);
    }
  ]);
...
(function() {
  ...
  this.mainCtrl.controller("MainCtrl", [
    '$scope', '$interval', '$window', 'NetManager', 'Helper', 'nodeValidator', function($scope, $interval, $window, NetManager, Helper, nodeValidator) {
      ...
      $scope.ok = {};
      return angular.extend($scope, scattrs);
    }
  ]).directive('allInOne', [
...
(function() {
  this.sessionCtrl = angular.module('sessionController', []);

  this.sessionCtrl.controller("UserSessionCtrl", [
    '$scope', '$interval', '$window', 'NetManager', function($scope, $interval, $window, NetManager) {
      var scope_attrs;
      scope_attrs = {};
      return angular.extend($scope, scope_attrs);
